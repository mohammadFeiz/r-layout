...
export type I_RVD_classes = {
    [key: string]: string | ((node: I_RVD_node, parent: I_RVD_node) => string);
};
export type I_RVD_props = {
    rootNode: I_RVD_node;
    dragHandleClassName?: string;
    classes?: I_RVD_classes;
    rtl?: boolean;
    state?: any;
    editNode?: I_RVD_editNode;
};
...
export type I_RVD_temp = {
    dragIndex?: false | number;
    lt?: string;
    time?: number;
    timeOut?: any;
};
export type I_RVD_context = {
    getTemp: I_RVD_getTemp;
    setTemp: I_RVD_setTemp;
    rootProps: I_RVD_props;
    state: I_RVD_state;
    setState: I_RVD_setState;
};
export type I_RVDNode = {
    node: I_RVD_node;
    index: number;
    parent?: I_RVD_node;
    level: number;
...
export default function ReactVirtualDom(props: I_RVD_props): JSX.Element;
export declare function animate(type: any, selector: any, callback: any): void;